...
def load_dataset():
    ...
    title_vectorizer = CountVectorizer(stop_words='english', max_features=200000,ngram_range=(1,2))
    desc_vectorizer = CountVectorizer(stop_words='english', max_features=300000,ngram_range=(2,3))
